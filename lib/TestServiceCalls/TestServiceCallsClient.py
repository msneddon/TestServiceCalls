...
class TestServiceCalls(object):
    ...
    def get_feature_ids(self, p, context=None):
        """
        ...
        return self._client.call_method(
            'TestServiceCalls.get_feature_ids',
            [p], self._service_ver, context)

    def status(self, context=None):
        return self._client.call_method('TestServiceCalls.status',
