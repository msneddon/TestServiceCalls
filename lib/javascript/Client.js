...
function TestServiceCalls(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_feature_ids = function (p, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "TestServiceCalls.get_feature_ids",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "TestServiceCalls.status",
